...
- Stage changes for needed data cleanup (Wrong Cert Status, Applications to be closed, improbable email address)
- various data snapshots
- prepend dates to cases; make them easier to merge
...
- profile updates waiting to be processed - profile update cases are now part of this instead of overnight.
    - profile updates should update the Audit right away and set up Portal Access - can I delay the email by an hour?
    - add the submitter to the case (where in the workflow?)
...
- Access iMIS through API as well
...
- report of possible consultants as cert contacts; mismatched email address
- next version of Nextiva script, with graphs built in